  ...
  return (
    <div className="relative w-full max-w-[360px] mx-auto lg:ml-auto">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 60% at 50% 50%, oklch(0.598 0.135 45 / 0.12) 0%, transparent 70%)",
          transform: "scale(1.3)",
        }}
      />
      ...
      <div className="card-enter rounded-2xl border border-border bg-surface shadow-warm-xl overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="space-y-3">
            <div>
              <p className="text-[10px] font-mono-ui text-text-muted uppercase tracking-widest mb-1">
                Product
              </p>
              <p className="text-[15px] font-semibold text-ink">QuickDeliver</p>
            </div>
            <div>
              <p className="text-[10px] font-mono-ui text-text-muted uppercase tracking-widest mb-1.5">
                Stack
              </p>
              <div className="flex gap-1.5 flex-wrap">
                {["Flutter", "Firebase", "Next.js"].map((t) => (
                  <span
                    key={t}
                    className="text-[11px] px-2 py-0.5 rounded-md bg-accent/10 text-accent font-mono-ui border border-accent/20"
                  >
                    {t}
                  </span>
                ))}
          ...
          {/* Features */}
          <div>
            <p className="text-[10px] font-mono-ui text-text-muted uppercase tracking-widest mb-2">
              Extracted features
            </p>
            <div className="space-y-1.5">
              {FEATURES.map((f, i) => (
                ...
                >
                  <svg
                    className="h-3.5 w-3.5 text-[oklch(0.55_0.18_145)] flex-shrink-0"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="3"
          ...
          {/* Approve button */}
          <div
            className={`transition-all duration-500 ${showApprove ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
          >
      ...
      <div className="rounded-2xl border border-[#2a2522] bg-[#0f0d0b] overflow-hidden shadow-warm-xl">
        ...
        {done && (
          <div className="px-5 pb-5 pt-1 flex gap-3">
            <Link
              to="/register"
              className="px-3 py-1.5 text-[12px] font-mono-ui rounded-lg bg-accent text-accent-foreground hover:bg-[oklch(0.55_0.135_45)] transition-colors btn-press"
            >
              ✓ Try it yourself →
            </Link>
...
const APPS = [
  {
    name: "QuickDeliver",
    desc: "Food delivery with real-time driver tracking and push notifications.",
    stack: "Flutter",
    hue: 60,
  },
  {
    name: "MeetMind",
    desc: "AI meeting assistant that summarises calls and creates action items.",
    stack: "Next.js",
    hue: 200,
  },
  {
    name: "ShipTrack",
    desc: "Logistics dashboard for tracking packages across multiple carriers.",
    stack: "Next.js",
    hue: 145,
  },
  {
    name: "PocketCoach",
    desc: "Personalised fitness app with workout plans and progress charts.",
    stack: "React Native",
    hue: 300,
  },
  {
    name: "TaskFlow",
    desc: "Project management tool built from a 30-minute team call.",
    stack: "Next.js",
    hue: 30,
  },
  {
    name: "StoreBase",
    desc: "E-commerce storefront with inventory and order management.",
    stack: "Flutter",
    hue: 250,
  },
];
...
const STEPS = [
  {
    ...
    body: "Add Forgefy to your Zoom, Google Meet, or Teams call. It joins silently, listens, and builds a structured picture of what your team is deciding.",
  },
  {
    n: "02",
    title: "It extracts what matters",
    body: "Features, entities, constraints, and conflicts — extracted in real time. Not a transcript. A proper product blueprint a senior PM would be proud of.",
  },
  {
    n: "03",
    title: "Review and approve",
    body: "Before anything is built you see exactly what Forgefy understood. Edit, approve, or send it back. You stay in control at every step.",
  },
  {
    n: "04",
    title: "Your app ships",
    body: "Flutter for iOS and Android, React Native for cross-platform, or Next.js for web — built from your blueprint in the stack you choose, pushed to GitHub automatically.",
  },
];
...
const PLANS = [
  {
    ...
    builds: "~1 build",
    updates: "~10 updates",
    features: ["500k tokens/month", "~1 app build", "~10 updates", "GitHub auto-push"],
  },
  {
    key: "starter",
    name: "Starter",
    ...
    <main className="min-h-screen page-gradient text-ink antialiased">
      ...
      <header className="h-14 border-b border-border sticky top-0 z-20 frost">
        <div className="h-full max-w-7xl mx-auto flex items-center justify-between px-6 md:px-10">
          ...
          <div className="hidden md:flex items-center gap-2.5">
            <a
              href="#demo"
              className="px-3.5 py-1.5 text-[13px] text-text-secondary border border-border rounded-lg hover:border-accent hover:text-ink transition-colors"
            >
              Watch demo
            </a>
            <ThemeToggle />
            <Link
              to="/login"
              className="px-3.5 py-1.5 text-[13px] text-text-secondary hover:text-ink transition-colors"
            >
              Log in
            </Link>
            <Link
              to="/register"
              className="px-4 py-1.5 text-[13px] font-medium bg-accent text-accent-foreground rounded-lg hover:bg-[oklch(0.55_0.135_45)] transition-colors btn-press shadow-warm-sm"
            >
              Get started →
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-border frost px-6 py-4 space-y-3 text-[14px] slide-up">
            ...
            <div className="pt-2 flex flex-col gap-2 border-t border-border">
              <Link
                to="/login"
                className="text-center py-2.5 border border-border rounded-xl text-text-secondary hover:text-ink transition-colors"
              >
                Log in
              </Link>
              <Link
                to="/register"
                className="text-center py-2.5 bg-accent text-accent-foreground rounded-xl font-medium btn-press"
              >
                Get started →
              </Link>
            </div>
      ...
      <section className="relative px-6 md:px-10 max-w-7xl mx-auto pt-20 pb-28 md:pt-28 md:pb-36 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-6 items-center">
          ...
          <div className="lg:col-span-6 xl:col-span-7">
            ...
            {/* Headline */}
            <h1
              className="font-display font-normal leading-[1.03] tracking-[-0.025em]"
              style={{ fontSize: "clamp(48px, 7.5vw, 88px)" }}
            >
              <span className="block hero-line" style={{ animationDelay: "80ms" }}>
                Your meeting
              </span>
              <span
                className="block hero-line italic text-text-secondary"
            ...
            >
              Forgefy joins your planning calls, extracts what your team decided, and ships your app
              in Flutter, React Native, or Next.js — automatically.
            </p>
      ...
      <div className="border-y border-border bg-surface/60 backdrop-blur-sm py-7 px-6 md:px-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
          {COMPANIES.map((name) => (
            <span
              key={name}
              className="font-display text-[16px] text-text-muted/50 hover:text-text-muted transition-colors whitespace-nowrap select-none"
            >
              {name}
            </span>
          ))}
      ...
      <section id="apps" ref={appsRef} className="px-6 md:px-10 max-w-7xl mx-auto py-24 md:py-32">
        ...
        <p className="reveal mt-4 text-[15px] text-text-muted max-w-[480px]">
          These products were described in planning calls and built by Forgefy — no developer needed
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {APPS.map((app) => (
            <div
              key={app.name}
              className="reveal group rounded-2xl border border-border bg-card card-hover hover:border-accent/40 overflow-hidden"
            >
              <div
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: "linear-gradient(135deg, transparent 60%, oklch(0 0 0 / 0.04))",
                  }}
                />
              </div>
              <div className="p-5">
                <div className="flex items-center justify-between mb-2">
                  <p className="font-semibold text-[14px] text-ink group-hover:text-accent transition-colors">
                    {app.name}
                  </p>
      ...
      <section
        id="how"
        ref={howRef}
        className="bg-surface/60 backdrop-blur-sm border-y border-border px-6 md:px-10 py-24 md:py-32"
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl">
            {STEPS.map((step, i) => (
              <div
                key={step.n}
                className={`reveal grid grid-cols-[56px_1fr] gap-6 py-7 ${i === 0 ? "border-t" : ""} border-b border-border group`}
              >
                <div className="font-mono-ui text-[13px] text-accent pt-0.5 font-medium">
                  {step.n}
                </div>
                <div>
                  <h3 className="text-[17px] font-semibold text-ink group-hover:text-accent transition-colors">
                    {step.title}
                  </h3>
                  <p className="mt-2 text-[14px] leading-[1.7] text-text-secondary max-w-[500px]">
                    {step.body}
                  </p>
                </div>
              </div>
      ...
      <section id="demo" className="bg-[#1A1714] text-[#E8DFD3] py-24 md:py-32">
        <div className="px-6 md:px-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-5">
            <p
              className="font-display leading-[0.95] font-light text-[#E8DFD3]"
      ...
      <section
        id="pricing"
        ref={pricingRef}
        className="px-6 md:px-10 max-w-7xl mx-auto py-24 md:py-32"
      >
      ...
      <section ref={bottomRef} className="bg-[#1A1714] py-24 md:py-32 px-6 md:px-10 text-center">
        <h2
          className="reveal font-display font-normal text-[#E8DFD3] max-w-2xl mx-auto leading-[1.08]"
