...
function BillingPage() {
  ...
  const usedPct = status ? Math.min(100, (status.tokens_used / status.monthly_tokens) * 100) : 0;
    ...
    <div className="max-w-4xl mx-auto px-6 md:px-[8vw] py-12 space-y-10 page-enter">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 space-y-5 shadow-warm-xs slide-up">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between text-[11px] text-text-muted">
              <span>{formatTokens(status.tokens_remaining)} remaining</span>
              <span>
                ~{Math.floor(status.tokens_remaining / 300_000)} builds · ~
                {Math.floor(status.tokens_remaining / 50_000)} updates left
              </span>
            </div>
          </div>
        </div>
      ...
      <div>
            ...
            return (
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  {plan.price > 0 && <span className="text-[13px] text-text-muted ml-1">/mo</span>}
                </div>
        ...
        <p className="mt-5 text-[12px] text-text-muted">
          Payments processed by Notchpay. Accepts cards, MTN Mobile Money, and Orange Money. Token
